...
- n=5时：总数125个，三面涂色8个，两面涂色36个，一面涂色54个，无色27个

## 常见错误及引导
1. 误以为两面涂色有12n个：引导学生"棱中间有几个？顶点算进去了吗？"
2. 误以为三面涂色随n变化：引导学生"正方体有几个角？会变吗？"
3. 混淆一面涂色和无色：引导学生"无色在哪里？它能被看到吗？"
4. 忘记验证总数：提醒学生检查各类相加是否等于n³

## 典型例题（可作为课后练习）
例：棱长为5的大正方体，表面涂色后切开。
答：三面涂色=8；两面涂色=12×3=36；一面涂色=6×9=54；无色=27；验证8+36+54+27=125 ✅

## 进阶挑战（学有余力时）
- 如果只涂两个相邻的面，怎么计算各类个数？
- 如果是长方体（a×b×c），公式会怎样变化？
`;
